...
public class ReservationController {
	...
	public String thankCustomer(Model model) {
	...
	//예약하기
	@PostMapping("/form")
	public String form(Reservation reservation,
	                   @RequestParam("orderMenu") String[] orderMenus,
	                   @RequestParam("menuCount") int[] menuCounts,
	                   Model model) {
